...
Image uploads use immediate upload (Refine best practice). Orphan files (uploaded but form never saved) are cleaned up automatically via **pg_cron** weekly (every Sunday at 02:00 UTC).
